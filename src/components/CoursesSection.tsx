...
const courses = [
  ...
  {
    title: "Keyboard",
    description: "Master piano and keyboard with structured lessons for all levels.",
  ...
  {
    title: "Violin",
    description: "Classical violin training with focus on technique and expression.",
    image: "https://images.unsplash.com/photo-1510915228350-0c82a2720669?w=400&q=80",
    href: "#courses",
  },
  {
    title: "Dance",
    description: "Contemporary, classical, and western dance forms for all ages.",
...
export default function CoursesSection() {
  return (
    <section id="courses" className="bg-overlay px-4 py-16 sm:px-6 sm:py-24 lg:px-8 lg:py-28">
      <div className="mx-auto max-w-7xl">
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted">
            From music to dance and art, we offer comprehensive courses for learners of all ages.
          </p>
        </div>
